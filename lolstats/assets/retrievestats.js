...
var player = "";
var playerId, playerStats, playerMatchHistory, xmlhttp;
...
function showChart(){
	...
	$("#winChart").remove();
	$("#chartContainer").append('<canvas id="winChart" width="400" height="400">ERROR: Browser does not support canvas tags.</canvas>');
